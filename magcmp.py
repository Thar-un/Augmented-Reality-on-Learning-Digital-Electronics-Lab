    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if((x > 457) and (x < 600)):
            if((y > 700) and (y < 748)):
                ...
                if d5 > e5:
                    print("a>b");
                    cv2.putText(img , "1", (522 ,570), cv2.FONT_HERSHEY_COMPLEX, 0.75, (0,0,0), 1, cv2.LINE_AA)
                    cv2.imshow(window_name,img)
                if d5 == e5:
                    print("a==b");
                    cv2.putText(img , "1", (557 ,570), cv2.FONT_HERSHEY_COMPLEX, 0.75, (0,0,0), 1, cv2.LINE_AA)
                    cv2.imshow(window_name,img)
                if d5 < e5:
                    print("a<b");
                    cv2.putText(img , "1", (597 ,570), cv2.FONT_HERSHEY_COMPLEX, 0.75, (0,0,0), 1, cv2.LINE_AA)
                    cv2.imshow(window_name,img)
...
cv2.putText(img , "IC- 7485 DIGITAL COMPARATOR", (420 ,70), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "A digital comparator ", (7 ,309), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "or magnitude comparator", (7 ,330), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "is a hardware electronic", (7 ,360), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "device that takes two", (7 ,390), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "numbers as input in ", (7 ,410), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "binary form and ", (7 ,440), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "determines whether one", (7 ,470), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "less than or equal ", (7 ,500), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
cv2.putText(img , "to the other number", (7 ,530), font, fontScale, (0,0,0), 1, cv2.LINE_AA)
#cv2.putText(img , "number is greater than", (420 ,70), font, fontScale, (0,0,0), thickness, cv2.LINE_AA)
